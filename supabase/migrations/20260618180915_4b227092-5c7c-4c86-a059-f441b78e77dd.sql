...
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS edited_at timestamptz NULL;
...
GRANT EXECUTE ON FUNCTION public.save_order_edit(uuid, jsonb) TO anon, authenticated, service_role;
